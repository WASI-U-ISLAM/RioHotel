...
{
    public partial class AC_Booking : UserControl
    {
        public AC_Booking()
        {
            InitializeComponent();
        ...
        private void AC_Booking_Load(object sender, EventArgs e)
        {
        ...
        private void checkinDateTimePicker_ValueChanged_1(object sender, EventArgs e)
        {

        }

        private void checkoutDateTimePicker_ValueChanged_1(object sender, EventArgs e)
        {
        ...
        private void fullpricepaidTextBox_TextChanged(object sender, EventArgs e)
        {
